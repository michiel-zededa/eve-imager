...
if(BUILD_CLI_ONLY)
    ...
    # GUI build: install full desktop integration (EVE Imager branding)
    install(FILES "${CMAKE_CURRENT_LIST_DIR}/icon/eve-imager.png" DESTINATION share/icons/hicolor/256x256/apps)
    install(FILES "${CMAKE_CURRENT_LIST_DIR}/icon/eve-imager-128.png" RENAME eve-imager.png DESTINATION share/icons/hicolor/128x128/apps)
