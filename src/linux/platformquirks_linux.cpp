...
static bool installPolkitPolicyForPath(const char* appImagePath) {
    ...
    QString policyContent = QString(
        ...
        "<policyconfig>\n"
        "  <vendor>ZEDEDA, Inc.</vendor>\n"
        "  <vendor_url>https://www.zededa.com/</vendor_url>\n"
        "  <action id=\"%1\">\n"
        "    <description>Run EVE Imager</description>\n"
        "    <message>Authentication is required to run EVE Imager</message>\n"
        "    <icon_name>eve-imager</icon_name>\n"
        "    <defaults>\n"
