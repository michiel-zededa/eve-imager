...
bool DownloadThread::_openAndPrepareDevice()
{
    ...
    if (result != rpi_imager::FileError::kSuccess)
    {
        ...
        msg += "<br>"+tr("Please verify if 'EVE Imager' is allowed access to 'removable volumes' in privacy settings (under 'files and folders' or alternatively give it 'full disk access').");
